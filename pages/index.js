...
export default function Home({ allData: { nasaData, quoteData }}) {
  return (
    <div class="flex justify-center items-center w-screen h-screen bg-no-repeat bg-cover bg-center" style={{ backgroundImage: (nasaData.url && nasaData.media_type === 'photo') ? `url('${(nasaData.url)}')` : 'url(/galaxy.jpg)', }}>
      <Head>
        <title>Quote of the Day</title>
        <meta name="description" content="Generated by create next app" />
        <link rel="icon" href="/heart-solid.png" />
      ...
      <main>
      <div>
        <div class="max-w-md rounded-xl p-10 m-10 bg-gradient-to-t from-black/50 to-black/20 text-white font-serif md:p-16 md:max-w-xl lg:max-w-3xl xl:max-w-5xl">
